...
outdir <- "/projects/nforde/HCP/stats/HCP/matched"
...
#match groups!
sub <- demogs[c("Subject", "Gender", "Age_in_Yrs")]
    
sub$treat <- ifelse(sub$Gender == "M", 1, 0)
match.it <- matchit(treat ~ Age_in_Yrs, data=sub)
...
```{r}
outdir_combined <- "/projects/nforde/HCP/stats/combined_figures/matched"
