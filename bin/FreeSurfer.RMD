...
All.resAgeOUT <- merge(Vol.resZ, SC.resZ, by="Subject") %>% merge(CT.resZ, by.x="Subject", by.y="CT_Subject") %>% 
  merge(SA.resZ, by.x="Subject", by.y="SA_Subject") %>% 
  select(contains("age.resid")) %>% cbind(Vol.resZ[c("Subject", "Age_in_Yrs", "Sex")]) 
...
##CT
HCP_CTraw <- ggseg(CTplot_sig.raw, mapping=aes(fill=as.numeric(AgeResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=1)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
HCP_CTcor <- ggseg(CTplot_sig.cor, mapping=aes(fill=as.numeric(FullResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=1)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())

HCP_CTrawVR <- ggseg(CTplotVR_sig.raw, mapping=aes(fill=as.numeric(VR_Age_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
HCP_CTcorVR <- ggseg(CTplotVR_sig.cor, mapping=aes(fill=as.numeric(VR_Full_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())

##SA
HCP_SAraw <- ggseg(SAplot_sig.raw, mapping=aes(fill=as.numeric(AgeResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=0.5)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
HCP_SAcor <- ggseg(SAplot_sig.cor, mapping=aes(fill=as.numeric(FullResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=0.5)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())

HCP_SArawVR <- ggseg(SAplotVR_sig.raw, mapping=aes(fill=as.numeric(VR_Age_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
HCP_SAcorVR <- ggseg(SAplotVR_sig.cor, mapping=aes(fill=as.numeric(VR_Full_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
...
Comb_Cort_VR_plot <- plot_grid(PNC_SArawVR, PNC_SAcorVR, HCP_SArawVR,  HCP_SAcorVR, OASIS_SArawVR,  OASIS_SAcorVR,
                               PNC_CTrawVR, PNC_CTcorVR, HCP_CTrawVR, HCP_CTcorVR, OASIS_CTrawVR, OASIS_CTcorVR, align="hv", ncol = 6)
...
ggsave(Comb_Cort_VR_plot.file, Comb_Cort_VR_plot, dpi=600, width = 21, height = 18, units = "cm")
...
Comb_Cort_x_plot <- plot_grid(PNC_SAraw, PNC_SAcor, HCP_SAraw, HCP_SAcor, OASIS_SAraw,  OASIS_SAcor,
                              PNC_CTraw, PNC_CTcor, HCP_CTraw, HCP_CTcor, OASIS_CTraw, OASIS_CTcor, align="hv", ncol = 6)
...
ggsave(Comb_Cort_x_plot.file, Comb_Cort_x_plot, dpi=600, width = 21, height = 18, units = "cm")

#global
Comb_OV_Vio <- plot_grid((PNC_OVplots_vio[[1]] + ylab("TBV") + ylim(-4,4) +
                            theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))), NULL,
                          (HCP_OVplots_vio[[1]] + ylab("TBV") + ylim(-4,4) +
                           theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))), NULL ,
                          (OASIS_OVplots_vio[[1]] + ylab("TBV") + ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))), NULL,
          (PNC_OVplots_vio[[2]] +ylab("Cerebral GM") + ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio.res[[2]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio[[2]] +ylab("Cerebral GM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio.res[[2]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio[[2]] +ylab("Cerebral GM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio.res[[2]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio[[3]] +ylab("Cerebral WM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio.res[[3]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio[[3]] +ylab("Cerebral WM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio.res[[3]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio[[3]] +ylab("Cerebral WM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio.res[[3]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio[[4]] +ylab("Cerebellar GM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio.res[[4]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio[[4]] +ylab("Cerebellar GM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio.res[[4]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio[[4]] +ylab("Cerebellar GM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio.res[[4]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio[[5]] +ylab("Cerebellar WM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (PNC_OVplots_vio.res[[5]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio[[5]] +ylab("Cerebellar WM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (HCP_OVplots_vio.res[[5]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio[[5]] +ylab("Cerebellar WM")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          (OASIS_OVplots_vio.res[[5]] +ylab("")+ ylim(-4,4) +
                             theme(axis.ticks.x=element_blank(), axis.text = element_text(size=10), axis.title=element_text(size=14))),
          align="hv", ncol =6)#,
