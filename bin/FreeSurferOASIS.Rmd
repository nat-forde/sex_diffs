...
All.resAgeOUT <- merge(Vol.resZ, SC.resZ, by="Subject") %>% merge(CT.resZ, by.x="Subject", by.y="CT_Subject") %>% 
  merge(SA.resZ, by.x="Subject", by.y="SA_Subject") %>% 
  select(contains("age.resid")) %>% cbind(Vol.resZ[c("Subject", "Age", "Sex")]) 
...
##CT
OASIS_CTraw <- ggseg(CTplot_sig.raw, mapping=aes(fill=as.numeric(AgeResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=1)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
OASIS_CTcor <- ggseg(CTplot_sig.cor, mapping=aes(fill=as.numeric(FullResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=1)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())

OASIS_CTrawVR <- ggseg(CTplotVR_sig.raw, mapping=aes(fill=as.numeric(VR_Age_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
OASIS_CTcorVR <- ggseg(CTplotVR_sig.cor, mapping=aes(fill=as.numeric(VR_Full_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())

##SA
OASIS_SAraw <- ggseg(SAplot_sig.raw, mapping=aes(fill=as.numeric(AgeResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=0.5)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
OASIS_SAcor <- ggseg(SAplot_sig.cor, mapping=aes(fill=as.numeric(FullResid_Cohen)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#0033FF", mid="white", high="#FF3300", midpoint=0, limits=c(-1.4, 1.4), breaks=seq(-1,1,by=0.5)) + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())

OASIS_SArawVR <- ggseg(SAplotVR_sig.raw, mapping=aes(fill=as.numeric(VR_Age_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
OASIS_SAcorVR <- ggseg(SAplotVR_sig.cor, mapping=aes(fill=as.numeric(VR_Full_VR)), colour="black", size=0.4, position="stacked") +
  scale_fill_gradient2(low="#006600", mid="#FFFF99", high="#FF9900", midpoint=1.8, limits=c(1, 2.81), breaks=seq(1,2.81,by=0.5))  + 
  theme(legend.position="none", axis.title = element_blank(), axis.text= element_blank(), line=element_blank())
