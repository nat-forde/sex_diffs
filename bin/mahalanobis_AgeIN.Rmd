...
OASIS.Global.cos <- rbind(Global.cos5055m, Global.cos5560m, Global.cos6065m, Global.cos6570m ,Global.cos7075m, Global.cos7580m,
      Global.cos5055f, Global.cos5560f, Global.cos6065f, Global.cos6570f ,Global.cos7075f, Global.cos7580f) %>% as.data.frame(stringsAsFactors = F)
Global.cos <- rbind(Global.cosu10m, Global.cos1015m, Global.cos1520m, Global.cosu10f, Global.cos1015f, Global.cos1520f, 
                   ...
                   Global.cos5055m, Global.cos5560m, Global.cos6065m, Global.cos6570m ,Global.cos7075m, Global.cos7580m,
                   Global.cos5055f, Global.cos5560f, Global.cos6065f, Global.cos6570f ,Global.cos7075f, Global.cos7580f) %>% as.data.frame(stringsAsFactors = F)
...
OASIS.SC.cos <- rbind(SC.cos5055m, SC.cos5560m, SC.cos6065m, SC.cos6570m ,SC.cos7075m, SC.cos7580m,
      SC.cos5055f, SC.cos5560f, SC.cos6065f, SC.cos6570f ,SC.cos7075f, SC.cos7580f) %>% as.data.frame(stringsAsFactors = F)
SC.cos <- rbind(SC.cosu10m, SC.cos1015m, SC.cos1520m, SC.cosu10f, SC.cos1015f, SC.cos1520f, 
                   ...
                   SC.cos5055m, SC.cos5560m, SC.cos6065m, SC.cos6570m ,SC.cos7075m, SC.cos7580m,
                   SC.cos5055f, SC.cos5560f, SC.cos6065f, SC.cos6570f ,SC.cos7075f, SC.cos7580f) %>% as.data.frame(stringsAsFactors = F)
##SA
#PNC
...
OASIS.SA.cos <- rbind(SA.cos5055m, SA.cos5560m, SA.cos6065m, SA.cos6570m ,SA.cos7075m, SA.cos7580m,
      SA.cos5055f, SA.cos5560f, SA.cos6065f, SA.cos6570f ,SA.cos7075f, SA.cos7580f) %>% as.data.frame(stringsAsFactors = F)
SA.cos <- rbind(SA.cosu10m, SA.cos1015m, SA.cos1520m, SA.cosu10f, SA.cos1015f, SA.cos1520f, 
                   ...
                   SA.cos5055m, SA.cos5560m, SA.cos6065m, SA.cos6570m ,SA.cos7075m, SA.cos7580m,
                   SA.cos5055f, SA.cos5560f, SA.cos6065f, SA.cos6570f ,SA.cos7075f, SA.cos7580f) %>% as.data.frame(stringsAsFactors = F)
...
OASIS.CT.cos <- rbind(CT.cos5055m, CT.cos5560m, CT.cos6065m, CT.cos6570m ,CT.cos7075m, CT.cos7580m,
      CT.cos5055f, CT.cos5560f, CT.cos6065f, CT.cos6570f ,CT.cos7075f, CT.cos7580f) %>% as.data.frame(stringsAsFactors = F)
CT.cos <- rbind(CT.cosu10m, CT.cos1015m, CT.cos1520m, CT.cosu10f, CT.cos1015f, CT.cos1520f, 
                   ...
                   CT.cos5055m, CT.cos5560m, CT.cos6065m, CT.cos6570m ,CT.cos7075m, CT.cos7580m,
                   CT.cos5055f, CT.cos5560f, CT.cos6065f, CT.cos6570f ,CT.cos7075f, CT.cos7580f) %>% as.data.frame(stringsAsFactors = F)
